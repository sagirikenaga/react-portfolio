...
export default function Home() {
  return (
    <div>
      ...
      <p>
      Hello! My name is Sagiri (pronounced suh-gear-ee) Ikenaga and I am a student in the Full Stack Developer coding Bootcamp at U of T SCS. 
      ...
      I am passionate about the growing technology and software field, and hope to eventually integrate my work in these fields to apply to the medical field. 
      </p>
